...
public class Pelanggan extends javax.swing.JFrame {
    ...
    // Cek apakah koneksi berhasil atau gagal (null)
    if (conn == null) {
        JOptionPane.showMessageDialog(null, "Waduh, koneksi ke database gagal! Cek XAMPP atau nama DB.");
    } else {
        System.out.println("Koneksi aman, siap ambil data.");
    }
